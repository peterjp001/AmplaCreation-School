...
} from "../../httpRequest/studentRequest";
  ...
  methods: {
        ...
        .then((res) => {
          ...
          studentByStudentIdAndAcademicYear(
            ...
            .then((result) => { 
              ...
              this.studentRegisterData = result.data
            }) .catch(()=>{
              this.studentRegisterData = null;
              this.studentData = res.data;
            }
            )
        })
    ...
    registerStudent() {
      ...
      newStudentForAcademicYear({
        ...
        .then(res=>{console.log(res); this.studentRegisterData = res.data})
    ...
    <main class="mt-5">
      <div class="container-fluid">
        ...
        <div class="row m-0 card mt-4 p-3 text-center" v-if="this.error">
          <div class="col-lg-12">
            <h2 class="text-danger fw-bold lead">
              Erreur <i class="bi bi-exclamation-circle"></i>
            </h2>
        ...
        <div class="row m-0 shadow mt-2" v-if="this.studentData">
          ...
          <div class="col-sm-6 py-4 card" v-if="!this.studentRegisterData">
            <p class="mb-4">
              <span class="text-primary lead font-italic fw-bold me-1 border-bottom"
          ...
          <div class="col-sm-6 py-4 card" v-else>
            <p class="mb-4">
              <span class="text-primary lead font-italic fw-bold me-1 border-bottom"
                >Informations Académique
              </span>
            ...
            <table class="table table-striped">
              <tbody class="table-group-divider">
                <tr>
                  ...
                  <td>{{ this.studentRegisterData.gradeName }}</td>
                </tr>
                <tr>
                  <th scope="row">Derniere ecole:</th>
                  <td>{{ this.studentRegisterData.lastSchool }}</td>
                </tr>
                <tr>
                  <th scope="row">Dernière Classe:</th>
                  <td>{{ this.studentRegisterData.lastGrade }}</td>
                </tr>
              </tbody>
            </table>
          </div>
