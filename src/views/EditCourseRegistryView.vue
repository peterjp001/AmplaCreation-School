...
export default {
  ...
  data() {
    return {
      teachers:[], currentEmployee:{}, courseName:null, codeEmployee:null,day:null, timeStart:null, timeEnd:null,
  ...
  <div>
    ...
    <main class="mt-5">
      <div class="container-fluid">
        ...
        <div class=" mt-3 p-2">
          <div class="row mt-2 d-flex justify-content-center" v-if="this.getGradeRegistryData" >
          ...
          <div class="col-lg-5 p-3 card shadow">
            ...
            <table class="table">
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{this.getGradeRegistryData.employee.firstName}} {{(this.getGradeRegistryData.employee.lastName).toUpperCase()}}</td> 
                </tr>
                <tr>
            ...
            <div class="col-lg-5 p-4 card shadow">
              <div class="mb-4">
              <h5 class="text-center border-bottom fw-bold bg-primary text-light" >Entrez le(s) donné(es) a Modifier</h5>
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                  ...
                  <input type="time" id="timeStart" class="form-control"  @input="(event) => (timeStart = event.target.value.trim())"     > 
              </div>
              <div class="mb-3">
                  <label for="timeEnd" class="form-label">Heure Fin</label>
                  <input type="time" id="timeEnd" class="form-control" @input="(event) => (timeEnd = event.target.value.trim())" > 
              </div>
              <div class="mb-3">
                <SubmitButton
            id="editGradeCourse"
            ...
            :disabled="(this.courseName == null ||  this.codeEmployee == null) && this.timeStart == null && this.timeEnd == null  && this.day == null "
          />
              </div>
